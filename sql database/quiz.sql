...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2017 at 12:39 PM
...
(5, 'ravi', 'ravi', 'ravi', 'chennai', 'chennai', 0, 'mr.ravi@gmail.com'),
...
('idjir9pcq2d07764us8rdiq9n5', 11, 'how to use date( ) in mysql ?', 'now( )', 'today( )', 'date( )', 'time( )', 0, 1),
('idjir9pcq2d07764us8rdiq9n5', 11, 'how to use date( ) in mysql ?', 'now( )', 'today( )', 'date( )', 'time( )', 0, 1),
('h02pd3pek7342qq9mud8m8aef5', 8, 'What  Default Data Type ?', 'String', 'Variant', 'Integer', 'Boolear', 2, 1),
('h02pd3pek7342qq9mud8m8aef5', 8, 'What is Default Form Border Style ?', 'Fixed Single', 'None', 'Sizeable', 'Fixed Diaglog', 3, 3),
('h02pd3pek7342qq9mud8m8aef5', 8, 'Which is not type of Control ?', 'text', 'lable', 'checkbox', 'option button', 1, 3);
